        ...
        <>
            ...
            <section className="featured spad">
                <div className="container">
                        ...
                        {products.map((product, index) => (
                            <div key={index} className="col-lg-3 col-md-4 col-sm-6 mix">
                                <div className="featured__item">
                                    <div className="featured__item__pic" style={{ height: "250px", width: "100%" }}>
                                        <img
                                            src={`http://localhost:5000/${product.picture}`}
                                            alt={product.subcategory} style={{ width: '100%', height: '300px' }} />
                                    </div>
                                    <div className="featured__item__text">
                                        <h6>
                                            <Link to={`/singleproduct/${product._id}`} style={{ textTransform: "capitalize" }}>
                    ...
                    <a className="btn bg-primary py-2 px-3" onClick={addCart} href="#"><i className="bi bi-cart text-white"></i></a>

                    <Link to={`/singleproduct/${product._id}`} className="btn bg-secondary py-2 px-3">
                      <i className="bi bi-eye text-white" style={{ textTransform: "capitalize" }}></i>
                    </Link>
