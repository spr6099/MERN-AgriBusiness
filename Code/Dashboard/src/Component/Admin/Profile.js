      ...
      <div className="flex-grow-1">
        ...
        <section className="section about-section gray-bg ml-5 mt-5 " id="about">
          <div className="containers" style={{width:"1200px"}}>
              ...
              <div className="col-lg-6">
                <div className="about-text go-to">
                  ...
                  <p>
                    ...
                    The term dairy farmer is applied to those engaged primarily in milk production, whether from cattle, goats, sheep, or other milk producing animals. </p>
            ...
            {editing ? (
              <button className='btn btn-success' style={{marginLeft:"150px"}} onClick={handleSaveClick}>Save</button>
            ) : (
              <button className='btn btn-light' style={{marginLeft:"150px"}} onClick={handleUpdateClick}>Update profile</button>
            )}
          </div>
        </section>
